...
def plot_comparison(
    ...
    ax.text(2, -6, f"n={author_n}", ha="center", fontsize=9, color="gray")
...
def main(
    user_file: str = "/workspace/projects/non-assistant-sampling/outputs/consistency_sandbagging/kimi-k2-thinking/prefill_samples/moonshotai_kimi-k2/user/judgments.json",
    assistant_file: str = "/workspace/projects/non-assistant-sampling/outputs/consistency_sandbagging/kimi-k2-thinking/prefill_samples/moonshotai_kimi-k2/assistant/judgments.json",
    author_file: str = "/workspace/projects/non-assistant-sampling/outputs/consistency_sandbagging/kimi-k2-thinking/prefill_samples/moonshotai_kimi-k2/author/judgments.json",
    output_file: str = "outputs/consistency_sandbagging/kimi-k2-thinking/prefill_samples/moonshotai_kimi-k2/lie_awareness_comparison.png",
):
    plot_comparison(
