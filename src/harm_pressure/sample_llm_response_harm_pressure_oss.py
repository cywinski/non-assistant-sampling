...
IM_SYSTEM_START = "<|start|>system<|message|>You are ChatGPT, a large language model trained by OpenAI.\nKnowledge cutoff: 2024-06\n\nReasoning: high\n\n# Valid channels: analysis, commentary, final. Channel must be included for every message."
IM_SYSTEM_END = "<|end|>"
IM_USER_START = "<|start|>user<|message|>"
IM_USER_END = "<|end|>"
IM_ASSISTANT_START = "<|start|>assistant"
start_reasoning = "<|channel|>analysis<|message|>"
end_reasoning = "<|end|>"
ANSWER_PREFIX = "Answer: ("

model_name = "openai/gpt-oss-120b"
output_dir = "results/harm_pressure/gpt-oss-120b"
